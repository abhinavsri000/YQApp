        ...
        return (
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <ScrollView horizontal= {true} contentContainerStyle={{paddingBottom:20}}>
                        <RecentsAvatar avatarTitle="BB" storeName="Big Bazaar" color="green" />
                        <RecentsAvatar avatarTitle="RT" storeName="Reliance Trends" color="orange" />
                        <RecentsAvatar avatarTitle="S" storeName="Spencer's" color="blue" />
                        <RecentsAvatar avatarTitle="P" storeName="Pantaloons" color="indigo" />
                        <RecentsAvatar avatarTitle="VM" storeName="Vishal Mart" color="red" />
                    </ScrollView>
                </View>
